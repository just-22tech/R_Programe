...
## 36. You are given a dataset `student_scores.csv` containing StudentID and Score.

Load the data in R, calculate the average score, plot a histogram, and explain the pattern observed.
...
## 37. Assume a data frame with Year, Month, Temperature and Rainfall.

(i) Filter records where temperature > 25°C
(ii) Find average rainfall by year
(iii) Plot line chart of average monthly temperature.
...
## 39. Write an R program to test whether given data follows normal distribution using
...
## 41. Write an R program to create a line chart for given data with:
...
## 45. A teacher claims that student marks are normally distributed with mean μ = 80.

Given sample data, test the hypothesis using R and interpret the result.
